...
public class CarouselItem implements ClientElement {
    ...
    @Property
    @Parameter(value="alt", defaultPrefix=BindingConstants.LITERAL)
    private String alt;
    ...
    public boolean init(MarkupWriter w){
        ...
        w.element("img","src",imageSource,"alt",alt,"height",height+"px","width",width+"px");
    ...
    private void createPageLink(MarkupWriter w) {
        Link url=null;
        if(context!=null){
        ...
        w.element("a","href",url.toURI(), "title",alt);
    }

    private void createEventLink(MarkupWriter w) {
